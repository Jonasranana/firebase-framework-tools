      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest mb-5 border bg-blue-50 text-[#2b5a8f] border-blue-100">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <a
                key={card.href}
                href={card.href}
                className="group flex flex-col bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 overflow-hidden"
              >
                ...
                <div className="p-7 flex flex-col flex-1">
                  ...
                  <span className="inline-flex items-center gap-2 text-[#2b5a8f] font-bold group-hover:gap-3 transition-all">
